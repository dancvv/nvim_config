...
opt.clipboard = '' -- Don't use system clipboard by default (use Ctrl+C/V instead)
...
opt.guicursor = 'n-v-c:block,i-ci-ve:ver25,r-cr:hor20,o:hor50,a:blinkwait700-blinkoff400-blinkon250-Cursor/lCursor' -- Disable cursor blink
